...
<body>
        ...
        <section>
            <div class="container">
                <div class="client-registrationBx">
                    ...
                    <div class="client-formBx" id="registrationForms">
                        <form> 
                            <h2>Registration</h2>
                    ...
                    <div class="mb-3">
                        ...
                        <button type="button" onclick="showForm('pentester')">Register as PenTester</button>
                    </div>
                </form>
                    ...
                    <div class="mb-3">
                        <button type="submit" class="btn btn-primary">Submit</button>
                        <button type="button" onclick="showForm('client')">Register as Client</button>
                    </div>
                        </form>
                    </div>
                </div>
    ...
    function showForm(role) {
        ...
        if (clientForm && pentesterForm && registrationForms) {
            if (role === 'client') {
                clientForm.style.display = 'block';
                pentesterForm.style.display = 'none';
            } else if (role === 'pentester') {
                clientForm.style.display = 'none';
                pentesterForm.style.display = 'block';
            }
            // Hide the selection form after displaying the registration form
