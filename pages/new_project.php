            ...
            <div class= "form-container">
                <form  action="../processes/new_project.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col mb-3">
                            ...
                            <input type="text" id="description" name="description" class="form-control" style="height: 100px; width: 50%;" placeholder="Enter Project Description" pattern="^[a-zA-Z0-9_\s]{20,}$" 
